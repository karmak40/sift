...
/// Deletes documents and cleans up their stored files in one step. Screens
/// should call this instead of `DocumentRepository.delete` directly —
/// deleting only the DB row would leave the underlying file (or web blob
/// row) orphaned forever, since nothing else ever references a
/// `storageKey` once its `Document` row is gone.
///
